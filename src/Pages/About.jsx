...
import GerardoGarcia from "../assets/GerardoGarcia.png";
import KurtJulien from "../assets/KurtJulien.png";
  ...
  return (
    <div>
      <div className="team-list-container">
        ...
        <h2 className="h20">
          Papyrus empowers individuals to effortlessly capture, organize, and
          access their thoughts, ideas, and inspirations anytime, anywhere.
          Papyrus/Scriptura/Ostraca is dedicated to enhancing productivity,
          fostering creativity, and facilitating seamless collaboration in a
          digital age.
        </h2>
        ...
        <div className="team-list">
          <ul>
            <li>
              <div
                className={`member ${
                  expanded === "GerardoGarcia" ? "expanded" : ""
                }`}
                onMouseEnter={() => handleExpand("GerardoGarcia")}
                onMouseLeave={() => handleExpand("")}
              >
                <img src={GerardoGarcia} alt="Gerardo Garcia" />
                <p
                  className={activeMember === "GerardoGarcia" ? "active" : ""}
                  onClick={() => handleSetActiveMember("GerardoGarcia")}
                >
                  {expanded === "GerardoGarcia" &&
                ...
                <p onClick={() => handleSetActiveMember("GerardoGarcia")}>
                  Gerardo Garcia
                </p>
              </div>
            </li>
            <li>
              <div
                className={`member ${
                  expanded === "NikiKhanam" ? "expanded" : ""
                }`}
                onMouseEnter={() => handleExpand("NikiKhanam")}
                onMouseLeave={() => handleExpand("")}
              >
                <img src={NikiKhanam} alt="Niki Khanam" />
                <p
                  className={activeMember === "NikiKhanam" ? "active" : ""}
                  onClick={() => handleSetActiveMember("NikiKhanam")}
                >
                  {expanded === "NikiKhanam" &&
                ...
                <p onClick={() => handleSetActiveMember("NikiKhanam")}>
                  Niki Khanam
                </p>
              </div>
            </li>
            <li>
              <div
                className={`member ${
                  expanded === "StevenRouse" ? "expanded" : ""
                }`}
                onMouseEnter={() => handleExpand("StevenRouse")}
                onMouseLeave={() => handleExpand("")}
              >
                <img src={StevenRouse} alt="Steven Rouse" />
                <p
                  className={activeMember === "StevenRouse" ? "active" : ""}
                  onClick={() => handleSetActiveMember("StevenRouse")}
                >
                  {expanded === "StevenRouse" &&
                ...
                <p onClick={() => handleSetActiveMember("StevenRouse")}>
                  Steven Rouse
                </p>
              </div>
            </li>
            <li>
              <div
                className={`member ${
                  expanded === "KurtJulien" ? "expanded" : ""
                }`}
                onMouseEnter={() => handleExpand("KurtJulien")}
                onMouseLeave={() => handleExpand("")}
              >
                <img src={KurtJulien} alt="Kurt Julien" />
                <p
                  className={activeMember === "KurtJulien" ? "active" : ""}
                  onClick={() => handleSetActiveMember("KurtJulien")}
                >
                  {expanded === "KurtJulien" &&
                ...
                <p onClick={() => handleSetActiveMember("KurtJulien")}>
                  Kurt Julien
                </p>
              </div>
            </li>
