        ...
        <div>
            ...
            <h2 className="h20">
                ...
                <div className="team-list">
                    <ul>
                        <li>
                            <div className={`member ${expanded === 'GerardoGarcia' ? "expanded" : ""}`} onMouseEnter={() => handleExpand('GerardoGarcia')} onMouseLeave={() => handleExpand('')}>
                                <img src={GerardoGarcia} alt="Gerardo Garcia" />
                                <p className={activeMember === 'GerardoGarcia' ? "active" : ""} onClick={() => handleSetActiveMember('GerardoGarcia')}>{expanded === 'GerardoGarcia' && (
                                ...
                                <p onClick={() => handleSetActiveMember('GerardoGarcia')}>Gerardo Garcia</p>
                            </div>
                        </li>
                        <li>
                        ...
                        <li>
                            <div className={`member ${expanded === 'KurtJulien' ? "expanded" : ""}`} onMouseEnter={() => handleExpand('KurtJulien')} onMouseLeave={() => handleExpand('')}>
                                <img src={KurtJulien} alt="Kurt Julien" />
                                <p className={activeMember === 'KurtJulien' ? "active" : ""} onClick={() => handleSetActiveMember('KurtJulien')}>{expanded === 'KurtJulien' && (
                                ...
                                <p onClick={() => handleSetActiveMember('KurtJulien')}>Kurt Julien</p>
                            </div>
                        </li>
                    </ul>
                </div>
